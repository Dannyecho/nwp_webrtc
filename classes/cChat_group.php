 ...
 * @database table name   	chat_group
 */
	
	class cChat_group extends cCustomer_call_log{
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/chat_group.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/chat_group.json' ), true );
