 ...
 * @database table name   	chat_profile
 */
	
	class cChat_profile extends cCustomer_call_log{
		...
		public $table_name = 'chat_profile';
		
		public $default_reference = '';
		
		public $label = 'Chat Profile';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/chat_profile.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/chat_profile.json' ), true );
