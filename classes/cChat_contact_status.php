<?php
/**
 * demo_#[\AllowDynamicProperties]
class Class
 *
 * @used in  				demo_#[\AllowDynamicProperties]
class Function
 * @created  				Hyella Nathan | 23:26 | 30-Dec-2024
 * @database table name   	chat_contact_status
 */
	
	class cChat_contact_status extends cCustomer_call_log{
		...
		public $table_name = 'chat_contact_status';
		
		public $default_reference = '';
		
		public $label = 'Chat Contact Status';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/chat_contact_status.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/chat_contact_status.json' ), true );
