 ...
 * @database table name   	chat_messages
 */
	
	class cChat_messages extends cCustomer_call_log{
		...
		public $table_name = 'chat_messages';
		
		public $default_reference = '';
		
		public $label = 'Chat Messages';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/chat_messages.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/chat_messages.json' ), true );
